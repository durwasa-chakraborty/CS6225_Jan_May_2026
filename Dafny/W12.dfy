 ...
 * Variables can also be declared to be ghost, in which case they cannot be used in definition of
 normal variables.
*/
...
- Dafny will check that the parameter of the decreases clause reduces from the original call to the 
recursive call.
...
Dafny allows the parameter of the decreases clause to have different types. It pre-defines a well-founded relation
for different types:
